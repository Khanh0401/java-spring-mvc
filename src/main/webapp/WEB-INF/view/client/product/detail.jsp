<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <head>
                <meta charset="utf-8">
                <title> Detail ${get_data.name} </title>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="border rounded">
                                            <a href="#">
                                                <img src="/images/product/${get_data.image}" class="img-fluid rounded"
                                                    alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <h4 class="fw-bold mb-3"> ${get_data.name} </h4>
                                        <p class="mb-3"> ${get_data.factory} </p>
                                        ...
                                        <p class="mb-4"> ${get_data.shortDesc} </p>
